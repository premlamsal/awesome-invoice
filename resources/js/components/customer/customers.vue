  ...
  <div>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        ...
        <vue-excel-xlsx :data="customers" :columns="exportTableColumns" :filename="'customers'" :sheetname="'customersSheet'" class="btn btn-default">
         Excel
        </vue-excel-xlsx>
              ...
              <tr v-for="customer in customers" v-bind:key="customer.id">
                ...
                <td>{{customer.updated_at | moment("from", "now")}}</td>
                 <td>
                  ...
                  <button class="btn btn-outline-danger custom_btn_table" @click="deleteCustomer(customer.id)" v-if="hasPermission('delete_customers')">
  ...
  methods: {
        ...
        if (result.value) {
          axios
            ...
            .then(function(response) {
              ...
              let index_to_delete = currObj.customers.findIndex(customer => customer.id === id)
              currObj.customers.splice(index_to_delete, 1);
              currObj.$Progress.finish();
    ...
    autoCompleteTable() {
      ...
      if (this.searchTableKey != "") {
        ...
        let currObj = this;
        axios
          .post("/api/customers/search", { searchQuery: this.searchTableKey })
          .then(function(response) {
            currObj.isLoading = "";
