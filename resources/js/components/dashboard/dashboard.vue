            ...
            <div class="row">
              ...
              <div class="col-7 col-md-8">
                <div class="numbers">
                  ...
                  <p class="card-title">Rs. {{dash.purchase}}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-7 col-md-8">
                <div class="numbers">
                  ...
                  <p class="card-title">Rs. {{dash.invoice}}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-7 col-md-8">
                <div class="numbers">
                  ...
                  <p class="card-title">{{dash.product}}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="from-group">
                  ...
                  <select
                    v-model="before_month"
                    class="from-control"
                    @change="changeSalesChartMonth"
                  >
