      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <select v-model="store_id">
              <option selected v-for="store in stores" :value="store.id" v-bind:key="store.id">{{store.name}}</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group row mb-0">
          <div class="col-md-6 offset-md-4">
            <button type="submit" class="btn btn-primary" @click="setStore()">Ok</button>
          </div>
        </div>
      </div>
    </div>
