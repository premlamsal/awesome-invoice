  ...
  methods: {
    ...
    editRole(id) {
      ...
      axios
        ...
        .then(response => {
          ...
          Vue.set(this.role, "permission_id", response.data.data.permission.id);
          Vue.set(
            this.role,
            "permission_id_old",
            response.data.data.permission.id
          );
    ...
    autoCompleteTable() {
      ...
      if (this.searchTableKey != "") {
        ...
        let currObj = this;
        axios
          .post("/api/roles/search", { searchQuery: this.searchTableKey })
          .then(function(response) {
            currObj.isLoading = "";
