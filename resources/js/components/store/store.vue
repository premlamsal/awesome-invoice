          ...
          <div class="col-md-4">
            <form @submit="formSubmit" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea :class="['form-control']" v-model="store.detail"></textarea>
              ...
              <div class="form-group">
                ...
                />
                <span
                  v-if="errors.tax_percentage"
                  :class="['errorText']"
                >{{ errors.tax_percentage[0] }}</span>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                />
                <span
                  v-if="errors.profit_percentage"
                  :class="['errorText']"
                >{{ errors.profit_percentage[0] }}</span>
              </div>
              <div class="form-group">
        ...
        .then(function(response) {
          ...
          if (response.data.store.store_logo != null) {
            ...
            Vue.set(
              currObj.store,
              "store_logo",
              "/img/" + response.data.store.store_logo
            );
