            ...
            <div class="form-group" style="position: relative;">
              ...
              <div class="customer-search-suggestion">
                <div
                  ...
                  class="customer-search-suggestion-inner"
                >
                  <ul>
                    <li
              ...
              <b-button
                id="show-btn"
                @click="$bvModal.show('bv-modal-add-customer')"
          ...
          <div class="col-sm-4">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <span
                  v-if="errors['info.estimate_date']"
                  :class="['errorText']"
                >{{errors['info.estimate_date'][0]}}</span>
              </div>
              <div class="col-sm-6">
          ...
          <tbody>
            <tr v-for="(item,index) in items" v-bind:key="item.id">
              ...
              <td
                ...
                :class="{'table-error':errors['items.' + index + '.quantity']}"
              >
                <input
                  type="number"
                  :class="['form-control']"
              ...
              <td class="table-unit" :class="{'table-error':errors['items.' + index + '.unit']}">
                <template>
                  <select class="form-control" v-model="item.unit">
                    <option selected v-for="unit in units" v-bind:key="unit.id">{{unit.short_name}}</option>
                  </select>
                </template>
              </td>
...
export default {
  ...
  methods: {
    ...
    createEstimate() {
      ...
      let currObj = this;
      axios
        .post("/api/estimate", { info: this.info, items: this.items })
