    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <button
          ...
          style="float: right;"
          @click="printEstimate(info.estimate_no)"
        >
          ...
          <table class="table table-bordered table-form">
            ...
            <tbody>
              <tr v-for="(item) in items" v-bind:key="item.id">
                ...
                <td class="table-qty">{{item.unit}}</td>
            ...
            <tfoot>
              ...
              <tr>
                ...
                <td class="table-discount">{{info.discount}}</td>
              </tr>
              <tr>
                <td class="table-empty" colspan="3"></td>
...
export default {
  ...
  methods: {
    ...
    convertToWords() {
      this.info.grand_total_words = this.convertNumberToWords(
        this.info.grand_total
      );
    },
