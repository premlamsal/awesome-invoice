<template>
  <div>
    ...
    <b-modal id="bv-modal-add-permission" hide-footer>
      <template v-slot:modal-title>{{modalForName}}</template>
      ...
      <div class="row m-4">
        <div class="col-md-2">
          ...
          <div class="form-group">
            ...
            />
            <label class="form-check-label" for="view_customers">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_suppliers">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_invoices">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_purchases">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_products">Product</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_categories">Category</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="view_units">Unit</label>
          </div>
        </div>
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_customer">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_supplier">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_invoice">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_purchase">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="add_category">Category</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_customer">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_supplier">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_invoice">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="edit_purchase">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_customer">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_supplier">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_invoice">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_purchase">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_product">Product</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_category">Category</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="delete_unit">Unit</label>
          </div>
        </div>
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_customer">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_supplier">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_invoice">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_purchase">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="show_category">Category</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_customer">Customer</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_supplier">Supplier</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_invoice">Invoice</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_purchase">Purchase</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_product">Product</label>
          </div>
          <div class="form-group">
            <input
              class="form-check-input"
          ...
          <div class="form-group">
            <input
              ...
              v-model="checkedPermissions"
            />
            <label class="form-check-label" for="search_unit">Unit</label>
          </div>
        </div>
      </div>
      <!-- end of one row -->
      ...
      <div class="row">
        <div class="col-md-4">
          <div
            ...
            role="alert"
          >You can allow permissions like: Show, Search and View for the better experience. So, read full documentation before adding permission to user.</div>
        </div>
        <div class="col-md-4">
          <div
            class="alert alert-success"
            role="alert"
          >Some "Add" and "Edit" permissions need "View" permision to be given.</div>
        </div>
      </div>
